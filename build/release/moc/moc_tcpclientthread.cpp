...
#include "../../../include/tcpclientthread.h"
...
QT_MOC_LITERAL(6, 89, 14) // "startStreaming"

    },
    "TcpClientThread\0writeText\0\0clientConnected\0"
    "otherGuyDisconnected\0stopReceivingVideoStream\0"
    "startStreaming"
};
...
void TcpClientThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TcpClientThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientThread::startStreaming)) {
                *result = 4;
                return;
            }
        }
